      ...
      <div class="row">
        <div class="span12">
          <div class="inner-heading">
            <ul class="breadcrumb">
         <li><a href="<?php echo base_url('index.php/Index')?>">Halaman Utama</a> <i class="icon-angle-right"></i></li>
              <li><a href="<?php echo base_url('index.php/Index/pemisahberas')?>">Mesin Pemisah Beras</a> <i class="icon-angle-right"></i></li>
